    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='db.author')),
            ],
            options={
                'db_table': 'book',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='db.book')),
            ],
            options={
                'ordering': ['due_back'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='db.book')),
            ],
            options={
                'db_table': 'bookimage',
            },
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='db.genre'),
        ),
    ]
